          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-5/12 flex justify-center lg:justify-end relative">
              ...
              >
                ...
                <img 
                  src="https://cdn.pixabay.com/photo/2016/09/13/11/05/moon-cake-1666993_1280.jpg"
                  onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1558961363038-f53826b00b46?auto=format&fit=crop&w=800&q=80" }}
            ...
            <div className="w-full lg:w-7/12 text-center lg:text-left">
              ...
              >
                <div className="aspect-square rounded-lg overflow-hidden shadow-md">
                  <img src="https://cdn.pixabay.com/photo/2019/09/06/03/48/mooncake-4455431_1280.jpg" onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1514845565111-b5528c68eb93?auto=format&fit=crop&w=400&q=80" }} alt="Box 1" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="aspect-square rounded-lg overflow-hidden shadow-md">
                  <img src="https://cdn.pixabay.com/photo/2017/09/25/11/17/moon-cake-2784775_1280.jpg" onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1600617300768-2023d8816c49?auto=format&fit=crop&w=400&q=80" }} alt="Box 2" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="aspect-square rounded-lg overflow-hidden shadow-md">
                  <img src="https://cdn.pixabay.com/photo/2018/09/18/14/56/moon-cake-3686364_1280.jpg" onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1605807646983-377112959fd7?auto=format&fit=crop&w=400&q=80" }} alt="Box 3" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
                </div>
              </motion.div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch">
            ...
            <div className="w-full lg:w-2/3 relative flex">
              <div className="w-full rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-4 border-gold/40 relative group">
                <img 
                  src="https://cdn.pixabay.com/photo/2018/09/18/14/56/moon-cake-3686364_1280.jpg" 
                  onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1478144596220-d4128f114099?auto=format&fit=crop&w=1200&q=80" }}
